...
public class SeedPower : PowerBase
{
	public LayerMask Mask;
	public Transform Preview;
	public Seedling[] Prefabs;
	...
	public override GameObject Create(Vector2 position)
	{
		...
		if (hit)
		{
			var instance = Instantiate(Prefabs[Random.Range(0, Prefabs.Length)], hit.point, Quaternion.FromToRotation(Vector2.up, direction), Planet.Instance.Root);
